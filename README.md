...
### 👨🏻‍💻 Passos para Configuração
 ...
 ```bash
	git clone https://github.com/JBatistaln/cy-e2eburguer.git 
```
...
-   **Usuário perfil salão deve acessar aplicação pelo APP**:
	 -  Tenta logar com perfil salão e direciona para página de info para fluxo do app.    
      ...
      ### Demonstração 
    [Testes de Login](https://github.com/user-attachments/assets/1d5be5d7-23e6-4573-bff9-f02a5ec0f538)
...
## 📌 Notas Gerais
Feito com ❤️ por [João Batista](https://github.com/JBatistaln) 😊
